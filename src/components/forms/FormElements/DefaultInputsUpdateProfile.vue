      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div class="space-y-6">
          ...
          <input
            ...
            class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-gray-100 text-gray-400 px-4 py-2.5 text-sm shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
          />
      ...
      <div class="space-y-6">
        <div class="flex flex-col gap-2">
          ...
          <label
            ...
            :key="role.id"
            class="flex items-center text-gray-400 dark:text-white/40"
          >
            <input type="checkbox" disabled :value="role.id" v-model="form.roles" class="mr-2" />
            {{ role.role }}
          </label>
...
const submit = async () => {
  ...
  try {
    ...
    Swal.fire('Berjaya!', 'Pengguna telah dikemaskini.', 'success').then(() => {
