          ...
          >
            ...
            <td class="px-5 py-4 sm:px-6">
              <div class="flex gap-2">
                <RouterLink
                  :to="{ name: 'View Program Penganjur', params: { id: programs.id } }"
                ...
                <template v-if="String(programs.by_unit) === String(userStore.user.unit_id)">
                  ...
                  <RouterLink
                    :to="{ name: 'Borang Kemaskini Program.edit', params: { id: programs.id } }"
                ...
                <template v-else>
                  ...
                  <button
                    class="bg-red-300 text-white text-sm font-medium px-3 py-1 rounded opacity-50 cursor-not-allowed"
                    disabled
                  >
                    Padam
                  </button>
