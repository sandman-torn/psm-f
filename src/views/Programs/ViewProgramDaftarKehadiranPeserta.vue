<template>
  <admin-layout>
    ...
    >
      <h3 class="mb-5 text-lg font-semibold text-gray-800 dark:text-white/90 lg:mb-7">Pendaftaran Kehadiran Program</h3>
...
import { ref } from 'vue'
import ProfileCard from '../../components/programs/ProfileCardProgramDaftarKehadiranPeserta.vue'
import PersonalInfoCard from '../../components/programs/PersonalInfoCardProgramDaftarKehadiranPeserta.vue'
