<template>
  <admin-layout>
    ...
    >
      <h3 class="mb-5 text-lg font-semibold text-gray-800 dark:text-white/90 lg:mb-7">Pra Pendaftaran Program</h3>
...
import { ref } from 'vue'
import ProfileCard from '../../components/programs/ProfileCardProgramPreRegisterPeserta.vue'
import PersonalInfoCard from '../../components/programs/PersonalInfoCardProgramPreRegisterPeserta.vue'
