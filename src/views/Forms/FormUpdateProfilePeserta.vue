<template>
  <AdminLayout>
    ...
    <div class="grid grid-cols-1 gap-6">
      <div class="space-y-6">
        <ComponentCard title="Maklumat Pengguna">
          <DefaultInputs />
        </ComponentCard>
...
import DefaultInputs from '@/components/forms/FormElements/DefaultInputsUpdateProfile.vue'
...
const currentPageTitle = ref('Kemaskini Profil')
</script>
