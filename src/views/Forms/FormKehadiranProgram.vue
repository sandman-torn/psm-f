<template>
  <AdminLayout>
    ...
    <div class="grid grid-cols-1 gap-6">
      <div class="space-y-6">
        <ComponentCard title="Daftar Kehadiran Manual ">
          <DefaultInputs />
        </ComponentCard>
...
import DefaultInputs from '@/components/forms/FormElements/DefaultInputsProgramKehadiran.vue'
...
const currentPageTitle = ref('Kemaskini Program')
</script>
