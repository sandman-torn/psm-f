...
const login = async () => {
  loginAction(form).then(() => {
    // Redirect to pre-registration program after successful login
              ...
              <div>
                <form @submit.prevent="login">
                  <div class="space-y-5">
                    ...
                    <div>
                      ...
                      />
                      <p v-if="errors.ic_no" class="mt-2 text-sm text-red-600" id="ic_no-error">
                        {{ errors.ic_no[0] }}
                      </p>
                    </div>
                    <!-- Password -->
                ...
                <div class="mt-5">
                  ...
                  >
                    Tiada akaun?
                    <router-link
                      :to="{ path: '/signup-pre-register', query: { redirect: $route.query.redirect } }"
